...
use Berlioz\DocParser\Parser\DoctrineRst;
use DateTimeImmutable;
use League\Flysystem\FileAttributes;
use PHPUnit\Framework\TestCase;

class DoctrineRstTest extends TestCase
{
    protected function getParser(): DoctrineRst
    {
        return new DoctrineRst();
    }
...
EOF,
        ...
        $this->assertStringContainsString('<h1>', $page->getContents());
        $this->assertStringContainsString('Title H1', $page->getContents());
        $this->assertStringContainsString('<h2>', $page->getContents());
        $this->assertStringContainsString('Title H2', $page->getContents());
        $this->assertStringContainsString('<p>Content</p>', $page->getContents());
